...
from analyzer.utils.testing import compare_nodes
...
@pytest.mark.parametrize("root_id,batches,expected_tree", CASES)
@pytest.mark.asyncio
async def test_import(client, root_id, batches, expected_tree):
