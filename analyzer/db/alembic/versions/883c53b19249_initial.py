...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['unit_id'], ['price_updates.id'], name=op.f('fk__price_updates__unit_id__price_updates'), ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['parent'], ['shop_units.id'], name=op.f('fk__shop_units__parent__shop_units'), ondelete='CASCADE'),
